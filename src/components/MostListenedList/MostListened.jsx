...
import "./most-listened-style.css";

function MostListened() {
  return (
    <div className="most-listened-body">
      ...
      <div className="most-listened">
        <div className="most-listened-item">
          <div className="item-name">
            <span>1</span>
            <img
              className="mx-4"
              src="https://i.scdn.co/image/ab67616d00004851e753afb85223dca67441107b"
              width={40}
              alt=""
            />
