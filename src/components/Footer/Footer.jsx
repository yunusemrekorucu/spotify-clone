    ...
    <div className="footer">
      <div className="music-info">
        <img
          ...
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ61BJAcIRX5OFPQOjFt4a8Kd6l53tpWgxx6uKz0yngf_VowkJggtL4HEAzEDKJqSWljHo&usqp=CAU"
          alt=""
        />
        <div className="music-info-p">
          <p>Bu Saatten Sonra</p>
          <span>İkilem</span>
        </div>
        <svg
          role="img"
